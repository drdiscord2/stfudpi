...
> (Форк запрета от Flowseal сделанный для работы roblox, hypixel, whatsapp и тд)
> Тест стратегий: 1. Откройте service.bat
> 2. Run tests (10)
> 3. Ищите батник с меньшим количеством ошибок (в моем случае ALT10)
...
2. Скачайте архив (zip/rar) со [страницы последнего релиза](https://github.com/drdiscord/stfudpi/releases/latest) (ориг: https://github.com/Flowseal/zapret-discord-youtube/releases/latest)

4. Зайдите в свойства скачанного архива и поставьте галочку "Разблокировать". Если вы используете архиватор 7-Zip или PeaZip, этот шаг можно пропустить

5. Распакуйте содержимое архива по пути, который не содержит кириллицу/спец. символы

6. Запустите нужный файл
